  ...
  const response = await client.messages.create({
    ...
    messages: [{
      ...
      content: [
        ...
        {
          type: 'text',
          text: `This is a photo (possibly taken with a phone camera) of a kids dinosaur coloring page. The image may have:
- A dot grid pattern in the background (may be partially removed)
- Shadows, uneven lighting, or slight perspective skew from the camera
- Colorful crayon/marker coloring on a black outline drawing

1. What species of dinosaur is drawn? Look at the overall body shape: T-rex has big head + tiny arms, triceratops has a frill + horns, brachiosaurus has a very long neck. Answer exactly one of: trex, triceratops, brachiosaurus
2. Give the bounding box of JUST the dinosaur drawing (outline + any coloring inside it), excluding any dot grid, text, shadows, or empty space around it. Return as fractions of image width/height.
